    ...
    <div className="bg-neutral-100 flex flex-col items-center">
      <div className="flex w-full max-w-[1200px] flex-col items-center mt-5 px-5 max-md:max-w-full max-md:mt-10">
        <div className="bg-primary p-6 rounded-3xl w-full max-w-[1200px]">
          ...
          <p className="text-l font-normal text-background mb-4">
            Tenggat Waktu : 25 Desember 2023
          </p>
          <p className="text-sm font-light text-background mb-4">
            1 Laporan Membutuhkan Konfirmasi Anda
          </p>
                  ...
                  <div class="flex items-center">
                    <div className="flex flex-row">
                      ...
                      <div class="inline-flex flex-col items-end text-base font-semibold dark:text-white ml-4">
                        <button className="bg-primary text-background p-3 text-sm rounded-full hover:bg-blue-800">
                          Konfirmasi
                        </button>
                      </div>
                    </div>
...
export default LaporanKonfirmasiOrtu;
