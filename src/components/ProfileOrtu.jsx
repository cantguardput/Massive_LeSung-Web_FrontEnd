          ...
          <div className="bg-background p-6 rounded-3xl w-full max-w-[1200px]">
            <div className="flex flex-row grid grid-cols-2 items-right">
              <div class="justify-start ms-2 flex flex-row items-center">
                <img class="w-32 h-32 rounded-full shadow-lg" src="src/assets/img/guru-1.jpg" alt="" />
                <div className="justify-start ms-2 flex flex-col pl-5">
                  <h3 class="mb-1 text-3xl font-semibold text-heading dark:text-white">Muhammad Abidin</h3>
                  <p className="mb-1 text-l font-semibold text-gray-700 dark:text-white">Agama Islam</p>
                </div>
              </div>
