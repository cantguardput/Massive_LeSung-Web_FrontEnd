      ...
      <div className="flex w-full max-w-[1200px] flex-col items-center mt-5 px-5 max-md:max-w-full max-md:mt-10">
        <div className="bg-primary p-6 rounded-3xl w-full max-w-[1200px]">
          <div class="flex items-center justify-between mb-4">
            <h5 class="text-4xl font-bold leading-none text-white dark:text-white">Detail Laporan</h5>
          </div>
          <p className="text-l font-normal text-white mb-4">Tenggat Waktu : 25 Desember 2023</p>
                  ...
                  <div class="flex items-center">
                    <div className="flex flex-row">
                      <div class="flex-1 min-w-0 ms-4">
                        <p class="text-sm font-medium text-gray-900 truncate dark:text-white">Laporan Sesi 1</p>
                      ...
                      <div class="inline-flex flex-col items-end text-base font-semibold text-gray-900 dark:text-white">
                        ...
                        <img className="w-5 pt-5" src="src/assets/add_circle_FILL0_wght400_GRAD0_opsz24.svg" alt="" />
                      </div>
                    </div>
                  </div>
                </li>
        ...
        <div className="flex w-[228px] max-w-full items-stretch gap-3.5 mr-14 mt-14 self-end max-md:mr-2.5 max-md:mt-10 mb-5">
          <svg className="w-[50px] h-[50px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
